...
parser.add_argument(
    ...
    help="Optional smoke-test limit on reconstructions. Full evaluations leave this unset.",
)
if utils.is_interactive():
...
if max_images is not None:
    ...
    all_recons = all_recons[:max_images]
    all_clipvoxels = all_clipvoxels[:max_images]
    all_blurryrecons = all_blurryrecons[:max_images]
    all_predcaptions = all_predcaptions[:max_images]
...
base_ckpt_path = os.path.abspath('zavychromaxl_v30.safetensors')
